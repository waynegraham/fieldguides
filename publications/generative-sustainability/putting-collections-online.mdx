...
- **General-purpose AI assistants** can help draft translations, summaries, and transcripts, but institutions must review their privacy terms and verify all output.
- **Google Cloud Translation** provides machine translation through managed cloud services and application programming interfaces.
- **Microsoft Azure AI services** provide translation and speech-to-text capabilities for managed workflows.
...
- [Introduction to the International Image Interoperability Framework](https://iiif.io/get-started/)
